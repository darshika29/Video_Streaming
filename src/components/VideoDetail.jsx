...
const VideoDetail = () => {
  ...
  const [videoRecc, setVideoRecc] = useState(null)
  const { id } = useParams();
  ...
  useEffect(() => {
    ...
    fetchFromAPI(`search?part=snippet&relatedToVideoId=${id}&type=video`).then((data) => { setVideoRecc(data.items) });
  ...
  return (
    ...
    <Stack direction={{xs:'column',md:'row'}}>
        ...
        <Videos videos={videoRecc} direction={'column' } />
